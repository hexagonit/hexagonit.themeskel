...
- Lead image margin fix [vsomogyi]
...
- Ignore the LESS generated css files [dokai]

- Delete unused files and update the less files [vsomogyi]

- Documentation added [vsomogyi]

- Set the HTML5 doctype [dokai]

- Added tests. [dokai]

- Generate a functional test for the theme. [dokai]
